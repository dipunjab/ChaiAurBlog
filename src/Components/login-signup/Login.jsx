        ...
        <div className='md:w-1/2 flex flex-col justify-center p-2'>
          ...
          <form className="space-y-4">
            ...
            <input
              ...
              required
            />
            <button className="bg-customOrange hover:bg-orange-300 text-white p-3 w-2/4 ml-20 h-12 sm:ml-24 md:ml-2 rounded-full transition duration-300 md:w-3/4">Login</button>
          </form>
          <div className="text-center mt-2 md:text-left">
            <p>Don't have an account? <a href="#" className="text-orange-600 font-bold">Sign up</a></p>
          </div>
        </div>
      </div>
    </PageLayout>
